...
function wc_get_account_menu_items() {
	...
	$items = array(
		'dashboard'       => __( 'Tableau de bord', 'woocommerce' ),
		'orders'          => __( 'Commandes', 'woocommerce' ),
		'downloads'       => __( 'Téléchargements', 'woocommerce' ),
		'edit-address'    => _n( 'Adresses', 'Address', (int) wc_shipping_enabled(), 'woocommerce' ),
		'payment-methods' => __( 'Méthodes de paiement', 'woocommerce' ),
...
function wc_get_account_orders_columns() {
	$columns = apply_filters(
		...
		array(
			'order-number'  => __( 'Commande', 'woocommerce' ),
			'order-date'    => __( 'Date', 'woocommerce' ),
			'order-status'  => __( 'Etat', 'woocommerce' ),
...
function wc_get_account_orders_actions( $order ) {
	...
	$actions = array(
		'pay'    => array(
			...
			'name' => __( 'Payer', 'woocommerce' ),
		),
		'view'   => array(
			'url'  => $order->get_view_order_url(),
			'name' => __( 'Voir', 'woocommerce' ),
		),
		'cancel' => array(
			'url'  => $order->get_cancel_order_url( wc_get_page_permalink( 'myaccount' ) ),
			'name' => __( 'Annuler', 'woocommerce' ),
		),
	);
