	...
	public function get_endpoint_title( $endpoint ) {
		...
		switch ( $endpoint ) {
			case 'order-pay':
				...
				break;
			case 'order-received':
				$title = __( 'Commande reçue', 'woocommerce' );
				break;
			case 'orders':
				if ( ! empty( $wp->query_vars['orders'] ) ) {
					...
					$title = __( 'Commandes', 'woocommerce' );
				}
				break;
			case 'view-order':
				...
				break;
			case 'downloads':
				$title = __( 'Téléchargements', 'woocommerce' );
				break;
			case 'edit-account':
				$title = __( 'Détails du compte', 'woocommerce' );
				break;
			case 'edit-address':
				$title = __( 'Adresses', 'woocommerce' );
				break;
			case 'payment-methods':
				$title = __( 'Méthodes de paiement', 'woocommerce' );
				break;
			case 'add-payment-method':
				$title = __( 'Ajouter une méthode de paiement', 'woocommerce' );
				break;
			case 'lost-password':
				$title = __( 'Mot de passe perdu', 'woocommerce' );
				break;
			default:
				$title = '';
				break;
