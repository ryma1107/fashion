...
class WC_Countries {
	...
	public function get_default_address_fields() {
		if ( 'optional' === get_option( 'woocommerce_checkout_address_2_field', 'optional' ) ) {
			$address_2_placeholder = __( 'Appartement, Suite...', 'woocommerce' );
		} else {
		...
		$fields = array(
			...
			'country'    => array(
				'type'         => 'country',
				'label'        => __( 'Pays / Région', 'woocommerce' ),
				'required'     => true,
			...
			'address_1'  => array(
				...
				'placeholder'  => esc_attr__( 'Nom de la rue...', 'woocommerce' ),
				'required'     => true,
			...
			'state'      => array(
				'type'         => 'state',
				'label'        => __( 'Etat / Comté', 'woocommerce' ),
				'required'     => true,
				'class'        => array( 'form-row-wide', 'address-field' ),
