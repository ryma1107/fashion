...
function wc_get_order_statuses() {
	$order_statuses = array(
		'wc-pending'    => _x( 'En attente de paiement', 'Order status', 'woocommerce' ),
		'wc-processing' => _x( 'En cours', 'Order status', 'woocommerce' ),
		'wc-on-hold'    => _x( 'En attente', 'Order status', 'woocommerce' ),
		'wc-completed'  => _x( 'Terminée', 'Order status', 'woocommerce' ),
		'wc-cancelled'  => _x( 'Annulée', 'Order status', 'woocommerce' ),
		'wc-refunded'   => _x( 'Remboursée', 'Order status', 'woocommerce' ),
		'wc-failed'     => _x( 'Echouée', 'Order status', 'woocommerce' ),
	);
