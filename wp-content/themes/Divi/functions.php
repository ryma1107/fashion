...
if ( ! function_exists( 'et_show_cart_total' ) ) {
	function et_show_cart_total( $args = array() ) {
		...
		printf(
			...
			( ! $args['no_text']
				? esc_html( sprintf(
					_nx( '%1$s Article', '%1$s Articles', $items_number, 'WooCommerce items number', 'Divi' ),
...
function et_get_original_footer_credits() {
	return sprintf( __( 'Designed by %1$s | Powered by %2$s', 'Divi' ), '<a href="#" title="Premium WordPress Themes">Kam company</a>', '<a href="#">Kam company</a>' );
}
endif;
